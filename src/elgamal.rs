// This mod is vendored from https://github.com/iquerejeta/elgamal
// We need addition and subtraction of Ciphertext and Plaintext,
// where plaintext represents transaction fee.
